...
export function ContactTemplate04({ config, language }: BlockProps) {
  ...
  return (
    <div className="bg-gray-50 py-20 sm:py-28">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`mt-10 flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-500 ${
            isAr ? "flex-row-reverse" : ""
          }`}
        >
