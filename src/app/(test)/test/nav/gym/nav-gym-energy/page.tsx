...
import { NavGymEnergy } from "./nav-gym-energy";

export default function NavGymEnergyTestPage() {
    ...
    <div dir={language === "ar" ? "rtl" : "ltr"}>
      <div className="sticky top-0 z-50 bg-gray-950/90 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/test/nav/gym" className="text-gray-400 hover:text-white text-sm">← Back</Link>
          <span className="text-white font-semibold">Nav Gym Energy</span>
        </div>
      ...
      <div className="min-h-screen bg-black">
        <NavGymEnergy language={language} />
      </div>
    </div>
  );
}
