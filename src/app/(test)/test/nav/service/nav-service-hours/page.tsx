...
import { NavServiceHours } from "./nav-service-hours";

export default function NavServiceHoursTestPage() {
    ...
    <div dir={language === "ar" ? "rtl" : "ltr"}>
      <div className="sticky top-0 z-50 bg-gray-950/90 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-white font-semibold">Nav Service Hours</span>
        </div>
      ...
      <div className="min-h-screen bg-gray-100">
        <NavServiceHours language={language} />
      </div>
    </div>
  );
}
