...
import { NavPersonalMinimal } from "./nav-personal-minimal";

export default function NavPersonalMinimalTestPage() {
    ...
    <div dir={language === "ar" ? "rtl" : "ltr"}>
      <div className="sticky top-0 z-50 bg-gray-950/90 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-white font-semibold">Nav Personal Minimal</span>
        </div>
      ...
      <div className="min-h-screen bg-white">
        <NavPersonalMinimal language={language} />
      </div>
    </div>
  );
}
