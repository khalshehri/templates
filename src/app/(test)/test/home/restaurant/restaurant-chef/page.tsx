...
import { RestaurantChef } from "./restaurant-chef";

export default function RestaurantChefTestPage() {
    ...
    <div dir={language === "ar" ? "rtl" : "ltr"}>
      <div className="sticky top-0 z-50 bg-gray-950/90 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-white font-semibold">Restaurant Chef</span>
        </div>
      ...
      <RestaurantChef language={language} />
    </div>
  );
}
