...
import { CreativeShowcase } from "./creative-showcase";

export default function CreativeShowcaseTestPage() {
    ...
    <div dir={language === "ar" ? "rtl" : "ltr"}>
      <div className="sticky top-0 z-50 bg-gray-950/90 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/test/home/creative" className="text-gray-400 hover:text-white text-sm">← Back</Link>
          <span className="text-white font-semibold">Creative Showcase</span>
        </div>
      ...
      <CreativeShowcase language={language} />
    </div>
  );
}
