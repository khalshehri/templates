...
const templates = [
  { id: "law-gavel", name: "Law Gavel", description: "Gavel striking down with impact shockwave animation" },
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-2xl font-bold mt-4 mb-6">Law Firm</h1>
        <div className="grid gap-3">
          {templates.map((t) => (
            <Link key={t.id} href={`/test/home/law-firm/${t.id}`} className="bg-gray-900 border border-amber-500/30 hover:border-amber-500/50 rounded-xl p-4 transition-colors">
