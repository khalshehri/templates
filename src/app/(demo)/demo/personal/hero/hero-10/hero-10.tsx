...
const content = {
  en: { badge: "CREATIVE", heading: "Dream.", headingAccent: "Build. Inspire.", sub: "Multi-disciplinary creative turning passion projects into movements.", cta1: "See My Work", cta2: "Learn More" },
  ar: { badge: "مبدع", heading: "احلم.", headingAccent: "ابنِ. ألهم.", sub: "مبدع متعدد التخصصات يحوّل مشاريع الشغف إلى حركات.", cta1: "شاهد أعمالي", cta2: "اعرف المزيد" },
};
