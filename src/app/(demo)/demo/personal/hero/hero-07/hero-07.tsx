...
const content = {
  en: { badge: "MENTOR", heading: "Guiding", headingAccent: "Greatness", sub: "1-on-1 mentorship for aspiring entrepreneurs and leaders. 20+ years of experience.", cta1: "Apply for Mentorship", cta2: "Learn More" },
  ar: { badge: "مرشد", heading: "إرشاد", headingAccent: "العظمة", sub: "إرشاد 1-على-1 لرواد الأعمال والقادة الطموحين. 20+ سنة خبرة.", cta1: "قدّم للإرشاد", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Lightbulb className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
