...
const content = {
  en: { badge: "BLOGGER", heading: "Words That", headingAccent: "Matter", sub: "Thoughts, insights, and stories that inspire. A personal blog that resonates.", cta1: "Read Blog", cta2: "Learn More" },
  ar: { badge: "مدوّن", heading: "كلمات", headingAccent: "مهمة", sub: "أفكار ورؤى وقصص تُلهم. مدونة شخصية تتردد صداها.", cta1: "اقرأ المدونة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Pen className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
