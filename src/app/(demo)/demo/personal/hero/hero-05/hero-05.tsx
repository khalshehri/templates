...
const content = {
  en: { badge: "AUTHOR", heading: "Stories That", headingAccent: "Stay", sub: "Bestselling author of 5 books. Writing that entertains, educates, and inspires.", cta1: "Read Excerpts", cta2: "Learn More" },
  ar: { badge: "مؤلف", heading: "قصص", headingAccent: "تبقى", sub: "مؤلف 5 كتب من الأكثر مبيعاً. كتابة تسلي وتثقف وتلهم.", cta1: "اقرأ مقتطفات", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0ea5e9]/20 bg-[#0ea5e9]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <BookOpen className="w-4 h-4" style={{ color: "#0ea5e9" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#0ea5e9" }}>{t.badge}</span>
        </div>
