...
const content = {
  en: { badge: "SPEAKER", heading: "Ideas Worth", headingAccent: "Sharing", sub: "Keynote speaker on leadership, innovation, and digital transformation.", cta1: "Book Speaking", cta2: "Learn More" },
  ar: { badge: "متحدث", heading: "أفكار تستحق", headingAccent: "المشاركة", sub: "متحدث رئيسي في القيادة والابتكار والتحول الرقمي.", cta1: "احجز محاضرة", cta2: "اعرف المزيد" },
};
