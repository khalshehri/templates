...
const content = {
  en: { badge: "PLUMBING", heading: "Flow", headingAccent: "Freely", sub: "Expert plumbing services. Repairs, installations, and 24/7 emergency response.", cta1: "Book Plumber", cta2: "Learn More" },
  ar: { badge: "سباكة", heading: "تدفق", headingAccent: "بحرية", sub: "خدمات سباكة خبيرة. إصلاحات وتركيبات واستجابة طوارئ 24/7.", cta1: "احجز سبّاكاً", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0ea5e9]/20 bg-[#0ea5e9]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Droplets className="w-4 h-4" style={{ color: "#0ea5e9" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#0ea5e9" }}>{t.badge}</span>
        </div>
