...
const content = {
  en: { badge: "BEAUTY SALON", heading: "Glow", headingAccent: "Inside Out", sub: "Full-service beauty salon. Hair, nails, skin, and wellness treatments.", cta1: "Book Now", cta2: "Learn More" },
  ar: { badge: "صالون تجميل", heading: "توهّجي من", headingAccent: "الداخل والخارج", sub: "صالون تجميل متكامل. شعر وأظافر وبشرة وعلاجات عافية.", cta1: "احجزي الآن", cta2: "اعرف المزيد" },
};
