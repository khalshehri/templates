...
const content = {
  en: { badge: "ELECTRICAL", heading: "Power", headingAccent: "Solutions", sub: "Licensed electricians for residential and commercial projects. Emergency service available.", cta1: "Call Now", cta2: "Learn More" },
  ar: { badge: "كهرباء", heading: "حلول", headingAccent: "الطاقة", sub: "كهربائيون مرخصون لمشاريع سكنية وتجارية. خدمة طوارئ متاحة.", cta1: "اتصل الآن", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Zap className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
