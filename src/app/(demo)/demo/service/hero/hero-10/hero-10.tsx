...
const content = {
  en: { badge: "AUTO SERVICE", heading: "Drive", headingAccent: "Confident", sub: "Complete auto repair and maintenance. Factory-trained technicians.", cta1: "Schedule Service", cta2: "Learn More" },
  ar: { badge: "خدمة سيارات", heading: "قُد", headingAccent: "بثقة", sub: "إصلاح وصيانة سيارات كاملة. فنيون مدربون في المصنع.", cta1: "جدول الخدمة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#6366f1]/20 bg-[#6366f1]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Car className="w-4 h-4" style={{ color: "#6366f1" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#6366f1" }}>{t.badge}</span>
        </div>
