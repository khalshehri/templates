...
const content = {
  en: { badge: "CLEANING", heading: "Spotless", headingAccent: "Always", sub: "Professional cleaning services for homes and offices. Eco-friendly products.", cta1: "Get Quote", cta2: "Learn More" },
  ar: { badge: "تنظيف", heading: "نظافة", headingAccent: "دائماً", sub: "خدمات تنظيف احترافية للمنازل والمكاتب. منتجات صديقة للبيئة.", cta1: "احصل على عرض", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Leaf className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
