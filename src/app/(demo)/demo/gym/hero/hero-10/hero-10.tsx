...
const content = {
  en: { badge: "PERSONAL TRAINING", heading: "Your Goals", headingAccent: "Our Mission", sub: "1-on-1 personal training with certified coaches. Custom plans, real results.", cta1: "Meet Your Trainer", cta2: "Learn More" },
  ar: { badge: "تدريب شخصي", heading: "أهدافك", headingAccent: "مهمتنا", sub: "تدريب شخصي 1-على-1 مع مدربين معتمدين. خطط مخصصة، نتائج حقيقية.", cta1: "قابل مدربك", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22c55e]/20 bg-[#22c55e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Target className="w-4 h-4" style={{ color: "#22c55e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#22c55e" }}>{t.badge}</span>
        </div>
