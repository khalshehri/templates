...
const content = {
  en: { badge: "SWIMMING", heading: "Dive", headingAccent: "Deeper", sub: "Olympic-size pool, swim lessons, and aqua fitness for all levels.", cta1: "Start Swimming", cta2: "Learn More" },
  ar: { badge: "سباحة", heading: "غُص", headingAccent: "أعمق", sub: "مسبح أولمبي ودروس سباحة ولياقة مائية لجميع المستويات.", cta1: "ابدأ السباحة", cta2: "اعرف المزيد" },
};
