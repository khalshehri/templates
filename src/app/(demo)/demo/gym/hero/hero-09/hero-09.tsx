...
const content = {
  en: { badge: "GROUP FITNESS", heading: "Train", headingAccent: "Together", sub: "Energizing group classes. Spinning, dance, bootcamp, and more.", cta1: "See Classes", cta2: "Learn More" },
  ar: { badge: "لياقة جماعية", heading: "تدرّب", headingAccent: "معاً", sub: "حصص جماعية نشطة. دراجات ورقص وبوت كامب والمزيد.", cta1: "شاهد الحصص", cta2: "اعرف المزيد" },
};
