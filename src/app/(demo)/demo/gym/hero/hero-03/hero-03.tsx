...
const content = {
  en: { badge: "YOGA STUDIO", heading: "Find Your", headingAccent: "Balance", sub: "Traditional and modern yoga in a serene, mindful environment.", cta1: "View Schedule", cta2: "Learn More" },
  ar: { badge: "استوديو يوغا", heading: "جد", headingAccent: "توازنك", sub: "يوغا تقليدية وحديثة في بيئة هادئة وواعية.", cta1: "شاهد الجدول", cta2: "اعرف المزيد" },
};
