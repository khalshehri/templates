...
const content = {
  en: { badge: "PILATES", heading: "Strong", headingAccent: "Core", sub: "Reformer and mat Pilates for total body conditioning and flexibility.", cta1: "Book Session", cta2: "Learn More" },
  ar: { badge: "بيلاتيس", heading: "جذع", headingAccent: "قوي", sub: "بيلاتيس ريفورمر وحصيرة لتكييف الجسم الكامل والمرونة.", cta1: "احجز جلسة", cta2: "اعرف المزيد" },
};
