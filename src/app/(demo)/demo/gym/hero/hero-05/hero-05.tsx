...
const content = {
  en: { badge: "BOXING GYM", heading: "Fight", headingAccent: "Harder", sub: "Professional boxing training for all levels. Build strength, confidence, and discipline.", cta1: "Start Training", cta2: "Learn More" },
  ar: { badge: "ملاكمة", heading: "قاتل", headingAccent: "بقوة أكبر", sub: "تدريب ملاكمة احترافي لجميع المستويات. ابنِ القوة والثقة والانضباط.", cta1: "ابدأ التدريب", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Trophy className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
