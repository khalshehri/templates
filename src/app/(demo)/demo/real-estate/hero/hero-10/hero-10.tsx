...
const content = {
  en: { badge: "MORTGAGE", heading: "Your Dream.", headingAccent: "Our Numbers.", sub: "Get pre-approved in minutes. Best rates guaranteed with 50+ lending partners.", cta1: "Get Pre-Approved", cta2: "Learn More" },
  ar: { badge: "تمويل عقاري", heading: "حلمك.", headingAccent: "أرقامنا.", sub: "احصل على موافقة مبدئية في دقائق. أفضل معدلات مع 50+ شريك إقراض.", cta1: "احصل على موافقة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22c55e]/20 bg-[#22c55e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Calculator className="w-4 h-4" style={{ color: "#22c55e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#22c55e" }}>{t.badge}</span>
        </div>
