...
const content = {
  en: { badge: "NEW DEVELOPMENT", heading: "Coming", headingAccent: "Soon", sub: "Pre-launch access to the most anticipated development of 2025. Register your interest.", cta1: "Register Interest", cta2: "Learn More" },
  ar: { badge: "مشروع جديد", heading: "قريباً", headingAccent: "جداً", sub: "وصول مبكر لأكثر المشاريع ترقباً في 2025. سجّل اهتمامك.", cta1: "سجّل اهتمامك", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ec4899]/20 bg-[#ec4899]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Sparkles className="w-4 h-4" style={{ color: "#ec4899" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#ec4899" }}>{t.badge}</span>
        </div>
