...
const content = {
  en: { badge: "SMART HOMES", heading: "Live", headingAccent: "Smarter", sub: "Technology-integrated homes that adapt to your lifestyle. The future of living, today.", cta1: "View Listings", cta2: "Learn More" },
  ar: { badge: "منازل ذكية", heading: "عِش", headingAccent: "أذكى", sub: "منازل مدمجة بالتقنية تتكيف مع نمط حياتك. مستقبل السكن، اليوم.", cta1: "شاهد العروض", cta2: "اعرف المزيد" },
};
