...
const content = {
  en: { badge: "CONTENT CREATOR", heading: "Create.", headingAccent: "Inspire.", sub: "2M+ followers across platforms. I create content that educates, entertains, and converts.", cta1: "Watch Content", cta2: "Contact" },
  ar: { badge: "صانع محتوى", heading: "اصنع.", headingAccent: "ألهم.", sub: "2M+ متابع عبر المنصات. أصنع محتوى يثقف ويسلي ويحوّل.", cta1: "شاهد المحتوى", cta2: "تواصل" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ec4899]/20 bg-[#ec4899]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Play className="w-4 h-4" style={{ color: "#ec4899" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#ec4899" }}>{t.badge}</span>
        </div>
