...
const content = {
  en: { badge: "SOFTWARE ENGINEER", heading: "Clean Code", headingAccent: "Beautiful Products", sub: "Full-stack engineer passionate about writing elegant, maintainable code that scales.", cta1: "View GitHub", cta2: "Contact" },
  ar: { badge: "مهندس برمجيات", heading: "كود نظيف", headingAccent: "منتجات جميلة", sub: "مهندس Full-Stack شغوف بكتابة كود أنيق وقابل للصيانة والتوسع.", cta1: "شاهد GitHub", cta2: "تواصل" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22c55e]/20 bg-[#22c55e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Code2 className="w-4 h-4" style={{ color: "#22c55e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#22c55e" }}>{t.badge}</span>
        </div>
