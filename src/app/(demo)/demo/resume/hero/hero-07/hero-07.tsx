...
const content = {
  en: { badge: "ARCHITECT", heading: "Systems", headingAccent: "Thinker", sub: "Cloud architect designing distributed systems that handle billions of requests daily.", cta1: "Architecture Blog", cta2: "Contact" },
  ar: { badge: "مهندس معماري", heading: "مفكر", headingAccent: "أنظمة", sub: "مهندس سحابي يصمم أنظمة موزعة تعالج مليارات الطلبات يومياً.", cta1: "مدونة الهندسة", cta2: "تواصل" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Boxes className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all hover:shadow-[0_0_40px_#eab30840]" style={{ background: "#eab308" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
