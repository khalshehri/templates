...
const content = {
  en: { badge: "DATA SCIENTIST", heading: "Numbers", headingAccent: "Tell Stories", sub: "PhD in Machine Learning. I turn complex datasets into actionable business intelligence.", cta1: "View Research", cta2: "Contact" },
  ar: { badge: "عالم بيانات", heading: "الأرقام", headingAccent: "تحكي قصصاً", sub: "دكتوراه في التعلم الآلي. أحوّل مجموعات البيانات المعقدة إلى ذكاء أعمال قابل للتنفيذ.", cta1: "شاهد الأبحاث", cta2: "تواصل" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f97316]/20 bg-[#f97316]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <LineChart className="w-4 h-4" style={{ color: "#f97316" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f97316" }}>{t.badge}</span>
        </div>
