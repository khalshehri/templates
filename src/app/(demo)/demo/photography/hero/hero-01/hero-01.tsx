...
const content = {
  en: { badge: "PHOTOGRAPHY", heading: "Capture", headingAccent: "Moments", sub: "Professional photography for life's most important moments. Weddings, portraits, events.", cta1: "Book a Session", cta2: "Learn More" },
  ar: { badge: "تصوير", heading: "التقط", headingAccent: "اللحظات", sub: "تصوير احترافي لأهم لحظات الحياة. أعراس وبورتريهات وفعاليات.", cta1: "احجز جلسة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f43f5e]/20 bg-[#f43f5e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Camera className="w-4 h-4" style={{ color: "#f43f5e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f43f5e" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all" style={{ background: "#f43f5e" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
