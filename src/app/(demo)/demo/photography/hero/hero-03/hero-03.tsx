...
const content = {
  en: { badge: "WEDDING", heading: "Love", headingAccent: "Stories", sub: "Documenting love stories with timeless elegance. Every frame tells your story.", cta1: "Check Availability", cta2: "Learn More" },
  ar: { badge: "زفاف", heading: "قصص", headingAccent: "حب", sub: "نوثّق قصص الحب بأناقة خالدة. كل إطار يحكي قصتكم.", cta1: "تحقق من التوفر", cta2: "اعرف المزيد" },
};
