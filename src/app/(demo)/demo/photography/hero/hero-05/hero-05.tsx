...
const content = {
  en: { badge: "AERIAL", heading: "Above &", headingAccent: "Beyond", sub: "Drone photography and videography for real estate, events, and commercial projects.", cta1: "Get a Quote", cta2: "Learn More" },
  ar: { badge: "تصوير جوي", heading: "فوق", headingAccent: "وأبعد", sub: "تصوير بالطائرات بدون طيار للعقارات والفعاليات والمشاريع التجارية.", cta1: "احصل على عرض", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0ea5e9]/20 bg-[#0ea5e9]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Plane className="w-4 h-4" style={{ color: "#0ea5e9" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#0ea5e9" }}>{t.badge}</span>
        </div>
