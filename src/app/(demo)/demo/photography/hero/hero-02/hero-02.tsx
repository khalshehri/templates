...
const content = {
  en: { badge: "LANDSCAPE", heading: "See The World", headingAccent: "Through My Lens", sub: "Award-winning landscape photographer. Fine art prints available for collection.", cta1: "View Gallery", cta2: "Learn More" },
  ar: { badge: "مناظر طبيعية", heading: "شاهد العالم", headingAccent: "من عدستي", sub: "مصور مناظر طبيعية حائز على جوائز. مطبوعات فنية للبيع.", cta1: "شاهد المعرض", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Sun className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
