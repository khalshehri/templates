...
const content = {
  en: { badge: "PORTRAITS", heading: "The Real", headingAccent: "You", sub: "Portrait photography that captures authentic personality and emotion.", cta1: "Book Portrait", cta2: "Learn More" },
  ar: { badge: "بورتريه", heading: "أنت", headingAccent: "الحقيقي", sub: "تصوير بورتريه يلتقط الشخصية والمشاعر الحقيقية.", cta1: "احجز بورتريه", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#6366f1]/20 bg-[#6366f1]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Users className="w-4 h-4" style={{ color: "#6366f1" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#6366f1" }}>{t.badge}</span>
        </div>
