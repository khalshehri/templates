...
export function Hero04({ language }: { language: "en" | "ar" }) {
  ...
  useGSAP(() => {
    ...
    const origin = isAr ? "right" : "left";

    // Cross lines
    gsap.from(".hero04-cross-h", {
      scaleX: 0,
      duration: 1.2,
      ease: "power2.out",
      delay: 0.2,
      ...
      <Particles
        ...
        options={{
          ...
          particles: {
            ...
            color: { value: ["#d0cbc5", "#c0b8ae", "#b0a89e"] },
            shape: { type: "circle" },
            opacity: {
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              {[
                ...
                <a
                  key={item.idx}
                  href="#"
                  className="hero04-contact cursor-pointer"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: "10px",
