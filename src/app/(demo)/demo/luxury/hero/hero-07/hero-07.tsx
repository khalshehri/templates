...
const content = {
  en: { badge: "TIMEPIECES", heading: "Timeless", headingAccent: "Precision", sub: "Rare and vintage timepieces from the world's most prestigious manufacturers.", cta1: "View Watches", cta2: "Learn More" },
  ar: { badge: "ساعات", heading: "دقة", headingAccent: "خالدة", sub: "ساعات نادرة وعتيقة من أعرق المصنعين في العالم.", cta1: "شاهد الساعات", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Watch className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
