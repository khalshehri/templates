...
const content = {
  en: { badge: "FINE JEWELRY", heading: "Rare", headingAccent: "Brilliance", sub: "Hand-selected diamonds and precious gems. Certified, insured, extraordinary.", cta1: "View Collection", cta2: "Learn More" },
  ar: { badge: "مجوهرات فاخرة", heading: "تألق", headingAccent: "نادر", sub: "ألماس وأحجار كريمة مختارة يدوياً. معتمدة ومؤمّنة واستثنائية.", cta1: "شاهد المجموعة", cta2: "اعرف المزيد" },
};
