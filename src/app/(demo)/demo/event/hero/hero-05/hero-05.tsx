...
const content = {
  en: { badge: "CORPORATE", heading: "Elevate Your", headingAccent: "Brand Events", sub: "Corporate events that inspire, engage, and deliver measurable business impact.", cta1: "Request Proposal", cta2: "Learn More" },
  ar: { badge: "فعاليات شركات", heading: "ارفع", headingAccent: "فعاليات علامتك", sub: "فعاليات شركات تلهم وتشرك وتحقق أثراً تجارياً قابلاً للقياس.", cta1: "اطلب عرضاً", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Users className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
