...
const content = {
  en: { badge: "GALA DINNER", heading: "An Evening", headingAccent: "To Remember", sub: "Exclusive charity gala dinner with world-class entertainment and cuisine.", cta1: "Reserve Seat", cta2: "Learn More" },
  ar: { badge: "حفل عشاء", heading: "أمسية", headingAccent: "لا تُنسى", sub: "حفل عشاء خيري حصري مع ترفيه ومأكولات عالمية.", cta1: "احجز مقعداً", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f43f5e]/20 bg-[#f43f5e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Sparkles className="w-4 h-4" style={{ color: "#f43f5e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f43f5e" }}>{t.badge}</span>
        </div>
