...
const content = {
  en: { badge: "EVENT PLANNING", heading: "Make It", headingAccent: "Unforgettable", sub: "From intimate gatherings to grand galas. We create moments that last a lifetime.", cta1: "Plan Your Event", cta2: "Learn More" },
  ar: { badge: "تنظيم فعاليات", heading: "اجعلها", headingAccent: "لا تُنسى", sub: "من التجمعات الحميمة إلى الحفلات الكبرى. نصنع لحظات تدوم مدى الحياة.", cta1: "خطط لفعاليتك", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ec4899]/20 bg-[#ec4899]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <PartyPopper className="w-4 h-4" style={{ color: "#ec4899" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#ec4899" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all" style={{ background: "#ec4899" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
