...
const content = {
  en: { badge: "FASHION", heading: "Style Has", headingAccent: "No Limits", sub: "Luxury fashion from emerging and established designers. Express yourself.", cta1: "Browse Collection", cta2: "Learn More" },
  ar: { badge: "أزياء", heading: "الأناقة", headingAccent: "بلا حدود", sub: "أزياء فاخرة من مصممين ناشئين وراسخين. عبّر عن نفسك.", cta1: "تصفح المجموعة", cta2: "اعرف المزيد" },
};
