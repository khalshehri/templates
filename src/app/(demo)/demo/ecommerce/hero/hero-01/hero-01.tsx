...
const content = {
  en: { badge: "ONLINE STORE", heading: "Shop The", headingAccent: "Future", sub: "Curated collections, seamless checkout, same-day delivery. Shopping reimagined.", cta1: "Shop Now", cta2: "Learn More" },
  ar: { badge: "متجر إلكتروني", heading: "تسوّق", headingAccent: "المستقبل", sub: "مجموعات مختارة، دفع سلس، توصيل في نفس اليوم. التسوق بشكل جديد.", cta1: "تسوّق الآن", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f97316]/20 bg-[#f97316]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <ShoppingBag className="w-4 h-4" style={{ color: "#f97316" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f97316" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all" style={{ background: "#f97316" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
