...
const content = {
  en: { badge: "ECO STORE", heading: "Shop", headingAccent: "Sustainably", sub: "Zero-waste products for a better planet. Every purchase plants a tree.", cta1: "Shop Green", cta2: "Learn More" },
  ar: { badge: "متجر بيئي", heading: "تسوّق", headingAccent: "باستدامة", sub: "منتجات صفر نفايات لكوكب أفضل. كل شراء يزرع شجرة.", cta1: "تسوّق أخضر", cta2: "اعرف المزيد" },
};
