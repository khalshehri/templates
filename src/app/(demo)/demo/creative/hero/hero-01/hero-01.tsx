...
const content = {
  en: { badge: "DESIGN STUDIO", heading: "Create", headingAccent: "Bold", sub: "Design studio pushing boundaries of visual communication and digital art.", cta1: "See Our Work", cta2: "Learn More" },
  ar: { badge: "استوديو تصميم", heading: "ابتكر", headingAccent: "بجرأة", sub: "استوديو تصميم يدفع حدود التواصل البصري والفن الرقمي.", cta1: "شاهد أعمالنا", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ec4899]/20 bg-[#ec4899]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Palette className="w-4 h-4" style={{ color: "#ec4899" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#ec4899" }}>{t.badge}</span>
        </div>
