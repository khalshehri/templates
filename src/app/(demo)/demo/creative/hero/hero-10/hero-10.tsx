...
const content = {
  en: { badge: "CREATIVE AGENCY", heading: "Imagine", headingAccent: "More", sub: "Full-service creative agency for brands that refuse to blend in.", cta1: "Get Creative", cta2: "Learn More" },
  ar: { badge: "وكالة إبداعية", heading: "تخيّل", headingAccent: "أكثر", sub: "وكالة إبداعية شاملة للعلامات التي ترفض الاندماج.", cta1: "كن مبدعاً", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#6366f1]/20 bg-[#6366f1]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Camera className="w-4 h-4" style={{ color: "#6366f1" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#6366f1" }}>{t.badge}</span>
        </div>
