...
const content = {
  en: { badge: "ANIMATION", heading: "Bring Ideas", headingAccent: "To Life", sub: "3D animation, motion graphics, and visual effects for brands and entertainment.", cta1: "View Reel", cta2: "Learn More" },
  ar: { badge: "رسوم متحركة", heading: "أحيِ الأفكار", headingAccent: "للحياة", sub: "رسوم متحركة ثلاثية الأبعاد وموشن غرافيكس ومؤثرات بصرية.", cta1: "شاهد العرض", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#8b5cf6]/20 bg-[#8b5cf6]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Wand2 className="w-4 h-4" style={{ color: "#8b5cf6" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#8b5cf6" }}>{t.badge}</span>
        </div>
