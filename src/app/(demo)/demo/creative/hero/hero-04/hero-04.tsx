...
const content = {
  en: { badge: "VIDEO PRODUCTION", heading: "Visual", headingAccent: "Storytelling", sub: "Cinematic video production from concept to final cut. Commercials, docs, music videos.", cta1: "Start Project", cta2: "Learn More" },
  ar: { badge: "إنتاج فيديو", heading: "سرد", headingAccent: "بصري", sub: "إنتاج فيديو سينمائي من الفكرة إلى القطع النهائي. إعلانات ووثائقيات.", cta1: "ابدأ مشروعاً", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0ea5e9]/20 bg-[#0ea5e9]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Film className="w-4 h-4" style={{ color: "#0ea5e9" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#0ea5e9" }}>{t.badge}</span>
        </div>
