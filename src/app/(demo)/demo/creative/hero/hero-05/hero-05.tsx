...
const content = {
  en: { badge: "SOUND DESIGN", heading: "Hear The", headingAccent: "Difference", sub: "Original music, sound design, and audio branding for films, games, and brands.", cta1: "Listen", cta2: "Learn More" },
  ar: { badge: "تصميم صوتي", heading: "اسمع", headingAccent: "الفرق", sub: "موسيقى أصلية وتصميم صوتي وعلامات صوتية للأفلام والألعاب والعلامات.", cta1: "استمع", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#eab308]/20 bg-[#eab308]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Music className="w-4 h-4" style={{ color: "#eab308" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#eab308" }}>{t.badge}</span>
        </div>
