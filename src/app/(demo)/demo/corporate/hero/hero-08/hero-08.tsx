...
const content = {
  en: { badge: "OPERATIONS", heading: "Optimized", headingAccent: "Operations", sub: "Streamline your operations with AI-powered process automation.", cta1: "Optimize Now", cta2: "Learn More" },
  ar: { badge: "عمليات", heading: "عمليات", headingAccent: "محسّنة", sub: "بسّط عملياتك مع أتمتة العمليات المدعومة بالذكاء الاصطناعي.", cta1: "حسّن الآن", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f97316]/20 bg-[#f97316]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Cog className="w-4 h-4" style={{ color: "#f97316" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f97316" }}>{t.badge}</span>
        </div>
