...
const content = {
  en: { badge: "PARTNERSHIPS", heading: "Together", headingAccent: "We Grow", sub: "Strategic partnerships that create mutual value and lasting impact.", cta1: "Partner With Us", cta2: "Learn More" },
  ar: { badge: "شراكات", heading: "معاً", headingAccent: "ننمو", sub: "شراكات استراتيجية تخلق قيمة متبادلة وأثراً دائماً.", cta1: "كن شريكنا", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#ec4899]/20 bg-[#ec4899]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Handshake className="w-4 h-4" style={{ color: "#ec4899" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#ec4899" }}>{t.badge}</span>
        </div>
