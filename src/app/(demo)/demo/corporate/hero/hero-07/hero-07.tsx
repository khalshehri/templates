...
const content = {
  en: { badge: "ANALYTICS", heading: "Data-Driven", headingAccent: "Decisions", sub: "Enterprise analytics platform turning complex data into clear business insights.", cta1: "See Analytics", cta2: "Learn More" },
  ar: { badge: "تحليلات", heading: "قرارات", headingAccent: "مبنية على البيانات", sub: "منصة تحليلات مؤسسية تحوّل البيانات المعقدة إلى رؤى أعمال واضحة.", cta1: "شاهد التحليلات", cta2: "اعرف المزيد" },
};
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0ea5e9]/20 bg-[#0ea5e9]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <BarChart3 className="w-4 h-4" style={{ color: "#0ea5e9" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#0ea5e9" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all" style={{ background: "#0ea5e9" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
