...
const content = {
  en: { badge: "ONLINE COURSES", heading: "Learn", headingAccent: "Anywhere", sub: "500+ courses from industry experts. Learn at your pace, earn certificates.", cta1: "Browse Courses", cta2: "Learn More" },
  ar: { badge: "دورات أونلاين", heading: "تعلّم من", headingAccent: "أي مكان", sub: "500+ دورة من خبراء الصناعة. تعلّم بإيقاعك واحصل على شهادات.", cta1: "تصفح الدورات", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <BookOpen className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
