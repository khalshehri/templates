...
const content = {
  en: { badge: "KINDERGARTEN", heading: "Where Learning", headingAccent: "Begins", sub: "Nurturing environment for early childhood development. Play-based learning.", cta1: "Schedule Tour", cta2: "Learn More" },
  ar: { badge: "روضة أطفال", heading: "حيث يبدأ", headingAccent: "التعلّم", sub: "بيئة حاضنة لتنمية الطفولة المبكرة. تعلّم قائم على اللعب.", cta1: "جدول جولة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22c55e]/20 bg-[#22c55e]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Baby className="w-4 h-4" style={{ color: "#22c55e" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#22c55e" }}>{t.badge}</span>
        </div>
