...
const content = {
  en: { badge: "CODING BOOTCAMP", heading: "Code Your", headingAccent: "Career", sub: "12-week intensive bootcamp. From zero to job-ready full-stack developer.", cta1: "Enroll Now", cta2: "Learn More" },
  ar: { badge: "معسكر برمجة", heading: "برمج", headingAccent: "مسيرتك", sub: "معسكر مكثف 12 أسبوعاً. من الصفر إلى مطور Full-Stack جاهز للعمل.", cta1: "سجّل الآن", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#f97316]/20 bg-[#f97316]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Code2 className="w-4 h-4" style={{ color: "#f97316" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#f97316" }}>{t.badge}</span>
        </div>
