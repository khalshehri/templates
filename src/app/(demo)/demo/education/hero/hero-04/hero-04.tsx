...
const content = {
  en: { badge: "ART SCHOOL", heading: "Create", headingAccent: "Without Limits", sub: "Fine arts, digital design, and creative technology programs.", cta1: "View Programs", cta2: "Learn More" },
  ar: { badge: "مدرسة فنون", heading: "ابدع", headingAccent: "بلا حدود", sub: "برامج فنون جميلة وتصميم رقمي وتقنية إبداعية.", cta1: "شاهد البرامج", cta2: "اعرف المزيد" },
};
