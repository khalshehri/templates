...
const TEMPLATES: Record<string, Record<string, { id: string; name: string }[]>> = {
  hero: {
    company: [
      ...
      { id: "hero-11", name: "Split Image" },
      { id: "hero-12", name: "Cinematic Skyline" },
      { id: "hero-13", name: "Dashboard Preview" },
      { id: "hero-14", name: "Gradient Mesh" },
      { id: "hero-15", name: "Magazine Editorial" },
      { id: "hero-16", name: "Photo Grid Mosaic" },
      { id: "hero-17", name: "Portrait Spotlight" },
      { id: "hero-18", name: "Collage Overlap" },
      { id: "hero-19", name: "Retro Terminal" },
      { id: "hero-20", name: "Neon City" },
    ],
  },
};
