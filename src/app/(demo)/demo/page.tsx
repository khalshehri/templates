...
const TEMPLATES: Record<string, Record<string, { id: string; name: string }[]>> = {
  hero: {
    company: [
      { id: "hero-01", name: "Nexus Grid" },
      { id: "hero-02", name: "Horizon Light" },
      { id: "hero-03", name: "Orbital Command" },
      { id: "hero-04", name: "Glass Tower" },
      { id: "hero-05", name: "Data Hologram" },
      { id: "hero-06", name: "Wave Crest" },
      { id: "hero-07", name: "Stairway Rise" },
      { id: "hero-08", name: "Triple Pillar" },
      { id: "hero-09", name: "Pulse Network" },
      { id: "hero-10", name: "Aurora Drift" },
      { id: "hero-11", name: "Split Prism" },
      { id: "hero-12", name: "Matrix Rain" },
      { id: "hero-13", name: "Constellation" },
      { id: "hero-14", name: "Gradient Mesh" },
      { id: "hero-15", name: "Spotlight Stage" },
      { id: "hero-16", name: "Liquid Glass" },
      { id: "hero-17", name: "Neon Glow" },
      { id: "hero-18", name: "Geometric Mosaic" },
      { id: "hero-19", name: "Timeline Hero" },
      { id: "hero-20", name: "Topography Map" },
      { id: "hero-21", name: "Card Cascade" },
    ...
    freelancer: [
      ...
      { id: "hero-11", name: "Typewriter" },
      { id: "hero-12", name: "Analytics Dashboard" },
      { id: "hero-13", name: "Polaroid Grid" },
      { id: "hero-14", name: "Newspaper" },
      { id: "hero-15", name: "Stack Layers" },
      { id: "hero-16", name: "Marquee Banner" },
      { id: "hero-17", name: "Rate Card" },
