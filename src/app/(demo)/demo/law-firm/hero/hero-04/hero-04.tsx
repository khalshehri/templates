...
const content = {
  en: { badge: "REAL ESTATE LAW", heading: "Property", headingAccent: "Protected", sub: "Real estate transactions, title disputes, and property litigation specialists.", cta1: "Get Advice", cta2: "Learn More" },
  ar: { badge: "قانون عقاري", heading: "العقا��", headingAccent: "محمي", sub: "معاملات عقارية ونزاعات ملكية ومتخصصون في التقاضي العقاري.", cta1: "احصل على مشورة", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Home className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
