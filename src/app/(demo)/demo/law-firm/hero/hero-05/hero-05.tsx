...
const content = {
  en: { badge: "FAMILY LAW", heading: "Compassionate", headingAccent: "Advocacy", sub: "Family law with empathy. Divorce, custody, and adoption handled with care.", cta1: "Book Consultation", cta2: "Learn More" },
  ar: { badge: "قانون أسرة", heading: "مناصرة", headingAccent: "رحيمة", sub: "قانون أسرة بتعاطف. طلاق وحضانة وتبنّي يُعالج بعناية.", cta1: "احجز استشارة", cta2: "اعرف المزيد" },
};
