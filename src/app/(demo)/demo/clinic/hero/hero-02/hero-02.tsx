...
const content = {
  en: { badge: "FAMILY PRACTICE", heading: "Care That", headingAccent: "Listens", sub: "Personalized healthcare for every stage of life. Your family doctor, reimagined.", cta1: "Meet Our Team", cta2: "Learn More" },
  ar: { badge: "طب عائلي", heading: "رعاية", headingAccent: "تستمع", sub: "رعاية صحية شخصية لكل مرحلة من الحياة. طبيب عائلتك، بشكل جديد.", cta1: "تعرّف على فريقنا", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#10b981]/20 bg-[#10b981]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Stethoscope className="w-4 h-4" style={{ color: "#10b981" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#10b981" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all hover:shadow-[0_0_40px_#10b98140]" style={{ background: "#10b981" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
