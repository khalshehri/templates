...
const content = {
  en: { badge: "DENTAL CLINIC", heading: "Smile With", headingAccent: "Confidence", sub: "Advanced cosmetic and restorative dentistry. Transform your smile in a single visit.", cta1: "Book a Smile", cta2: "Learn More" },
  ar: { badge: "عيادة أسنان", heading: "ابتسم", headingAccent: "بثقة", sub: "طب أسنان تجميلي وترميمي متقدم. حوّل ابتسامتك في زيارة واحدة.", cta1: "احجز ابتسامتك", cta2: "اعرف المزيد" },
};
    ...
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center" style={{ background: "#080808" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#8b5cf6]/20 bg-[#8b5cf6]/10 mb-8" style={{ animation: "fadeInUp 0.6s ease-out both" }}>
          <Sparkles className="w-4 h-4" style={{ color: "#8b5cf6" }} /><span className="text-xs font-bold tracking-[0.2em] uppercase" style={{ color: "#8b5cf6" }}>{t.badge}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}>
          <button className="group inline-flex items-center gap-2 px-8 py-4 text-white font-bold rounded-xl transition-all hover:shadow-[0_0_40px_#8b5cf640]" style={{ background: "#8b5cf6" }}>{t.cta1}<ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1 rtl:rotate-180" /></button>
